...
const Product2 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202309/590556/1000265059_front_XXL.jpg?imgname=ถึงฉัน...คนที่อยู่ข้างกันเสมอ", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>ถึงฉัน...คนที่อยู่ข้างกันเสมอ</Text>
        ...
        <View style={styles.detail}>
          ...
          บางครั้งเราอาจลืมไปว่าคนที่อยู่ข้างเราตลอดเวลา คนที่รู้จักตัวเราดีมากที่สุด คือ “ตัวเรา”
          </Text>
        </View>
