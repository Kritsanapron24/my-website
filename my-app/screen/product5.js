...
const Product5 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202202/541412/1000246409_front_XXXL.jpg?imgname=52-เฮิรตซ์...คลื่นเสียงที่ไม่มีใครได้ยิน", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>52 เฮิรตซ์...คลื่นเสียงที่ไม่มีใครได้ยิน</Text>
