...
const Product15 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202303/574435/1000259567_front_XXXL.jpg?imgname=ชุด-คดีฆาตกรรมในคฤหาสน์หน้ากากมหัศจรรย์-เล่ม-1–2-(พิมพ์ครั้งที่-2)", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>คดีฆาตกรรมในคฤหาสน์</Text>
        ...
        <View style={styles.detail}>
          ...
          ว่ากันว่าบนโลกใบนี้จะมีคนหน้าตาเหมือนเราอย่างน้อย 3 คน ชิชิยะ คาโดมิ  ได้พบแล้วหนึ่งคน คือ ฮิยูกะ เคียวสุเกะ เมื่อปีค.ศ.1992 
          </Text>
        </View>
