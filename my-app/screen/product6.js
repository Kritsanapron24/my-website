...
const Product6 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202309/590043/1000264796_front_XXXL.jpg?imgname=มนุษย์เป็นสัตว์สังคม-(แค่บางวันก็พอ!)", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>มนุษย์เป็นสัตว์สังคม (แค่บางวันก็พอ!)</Text>
        ...
        <View style={styles.detail}>
          ...
          พักจากโลกที่วุ่นวาย...มาอยู่คนเดียวบ้างก็สบายใจดีเหมือนกันนะ
          </Text>
        </View>
