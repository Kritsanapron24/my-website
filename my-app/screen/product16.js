...
const Product16 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202306/581471/1000261615_front_XXXL.jpg?imgname=คดีฆาตกรรมในหอคอยกระจก", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>คดีฆาตกรรมในหอคอยกระจก</Text>
        ...
        <View style={styles.detail}>
          ...
          แขกผู้ได้รับเชิญต่างตื่นตระหนกเมื่อโศกนาฏกรรมเกิดขึ้นในอาคารหลังนี้ เจ้าของอาคารโดนวางยาพิษเกิดเหตุเพลิงไหม้ห้องอาหารและพบศพ
          </Text>
        </View>
