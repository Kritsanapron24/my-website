...
const Product12 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202310/591771/1000265439_front_XXXL.jpg?imgname=A-Wonderful-Lifeชีวิตนี้คู่ควรที่จะงดงาม", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>ชีวิตนี้คู่ควรที่จะงดงาม</Text>
        ...
        <View style={styles.detail}>
          ...
          ชีวิตของคนเรามีความหมายไหมถ้าชีวิตมีความหมาย สิ่งนั้นคืออะไร และเราจะเข้าถึงความหมายนั้นได้อย่างไร ในโลกอันโกลาหล
          </Text>
        </View>
