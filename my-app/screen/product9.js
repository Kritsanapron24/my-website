...
const Product9 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202106/528550/1000241706_front_XXXL.jpg?imgname=คดีฆาตกรรมในบ้านสิบเหลี่ยม", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>คดีฆาตกรรมในบ้านสิบเหลี่ยม</Text>
        ...
        <View style={styles.detail}>
          ...
          หนังสือแปล ขายดี นิยายสืบสวนสอบสวน แนวลึกลับ คดีฆาตกรรมในบ้านสิบเหลี่ยม
          </Text>
        </View>
