...
const Product11 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202308/588597/1000264199_front_XXXL.jpg?imgname=คำตอบของความสุข-:-Answers-of-Happiness", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>คำตอบของความสุข : Happiness</Text>
        ...
        <View style={styles.detail}>
          ...
          หนังสือที่ชวนคุณค้นหาคำตอบของความสุขถ้าคุณเคยประทับใจกับ ความลับของความสุข 
          </Text>
        </View>
