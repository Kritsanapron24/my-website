...
const Product14 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/201804/233134/1000206488_front_XXXL.jpg?imgname=ปาฏิหาริย์ร้านชำของคุณนามิยะ-โดย-ฮิงาชิโนะ-เคโงะ", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>ปาฏิหาริย์ร้านชำของคุณนามิยะ</Text>
        ...
        <View style={styles.detail}>
          ...
          นิยายแปล หนังสือขายดี โดย ฮิงาชิโนะ เคโงะ บอกเล่าเรื่องราวของหัวขโมย 3 คน ที่หลงเข้าไปใน ร้านชำของคุณนามิยะ
          </Text>
        </View>
