...
const Product7 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202209/559277/1000253755_front_XXXL.jpg?imgname=เมษาลาตะวัน", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>เมษาลาตะวัน</Text>
        ...
        <View style={styles.detail}>
          ...
          ความสัมพันธ์ระหว่างเด็กชายสามคน ถูกนิยามและนิยามตัวเองเป็นสิ่งแปลกปลอมปะปนอยู่ในเมืองเล็กๆ
          </Text>
        </View>
