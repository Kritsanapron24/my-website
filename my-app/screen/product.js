    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Image source={{
          ...
          style={{
            width: 200, height: 310, borderRadius: 10, borderColor: 'white',
            borderWidth: 3,
          }} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>52เฮิรตซ์...คลื่นเสียงที่ไม่มีใครได้ยิน</Text>
        <Text style={styles.price}>฿215.75</Text>
        ...
        <View style={styles.detail}>
          ...
          คุณค่าของตัวเราไม่ได้อยู่ที่คนอื่นให้ค่า แต่อยู่ที่เราให้ค่าและเคารพในเสียงของตัวเอง
          </Text>
        </View>
