...
const Product8 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202303/576258/1000260153_front_XXXL.jpg?imgname=เมื่อแมวที่บ้านคุณผันตัวเองมาเป็นไลฟ์โค้ช", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>เมื่อแมวที่บ้านคุณผันตัวเองมาเป็นไลฟ์โค้ช</Text>
        ...
        <View style={styles.detail}>
          ...
          นึกถึงตัวเองเป็นอันดับแรกไม่เคยเปรียบเทียบตัวเองกับใครไม่มานั่งกังวลเรื่องอดีตหรืออนาคตไม่ปล่อยให้เรื่องแย่ ๆ มาทำลายวันดี ๆ
          </Text>
        </View>
