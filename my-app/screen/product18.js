...
const Product18 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202306/582839/1000262088_front_XXXL.jpg?imgname=ช่วยด้วยครับ!-พี่สาวผมเป็นไซโคพาธ", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>ช่วยด้วยครับ! พี่สาวผมเป็นไซโคพาธ</Text>
        ...
        <View style={styles.detail}>
          ...
          "ยงอิน' ถูกแม่นำมาฝากไว้ที่สถานสงเคราะห์เด็กอยู่หลายปีจนถูกครอบครัวหนึ่งมารับอุปการะไป ครอบครัวนั้นมีลูกสาวเป็น Psychopath ชื่อ "ยุนทงจู' 
          </Text>
        </View>
