...
const Product1 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202006/506970/1000233334_front_XXXL.jpg?imgname=ร้านขนมแห่งความลับ-(พิมพ์ครั้งที่-2)", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>ร้านขนมแห่งความลับ(พิมพ์ครั้งที่-2)</Text>
        ...
        <View style={styles.detail}>
          ...
          ถึงแม้ว่าอารึมจะต้องอยู่บ้านตลอดเวลาด้วยโรคชราในเด็ก (หมายเหตุ - โรคที่ทำให้เด็กมีอัตราการเจริญเติบโตเร็วผิดปกติ เกิดมาก็แก่แล้ว)
          </Text>
        </View>
