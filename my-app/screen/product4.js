...
const Product4 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202309/589680/1000264632_front_XXXL.jpg?imgname=เมื่อเธอโตขึ้น-เธอจะเข้าใจเอง", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>เมื่อเธอโตขึ้น เธอจะเข้าใจเอง</Text>
        ...
        <View style={styles.detail}>
          ...
          นี่คือเรื่องราวของความแข็งแกร่ง ความรัก มิตรภาพ เป็นหนังสือที่เต็มไปด้วยอารมณ์ขันและความเป็นมนุษย์
          </Text>
        </View>
