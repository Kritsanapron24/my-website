...
const Product13 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={{ uri: "https://storage.naiin.com/system/application/bookstore/resource/product/202303/574332/1000259502_front_XXXL.jpg?imgname=ศาสตร์และศิลป์แห่งการเล่าเรื่องให้ตรึงใจด้วยวิทยาศาสตร์สมอง-:-The-Science-of-Storytelling", }}
            style={{ width: 200, height: 310, borderRadius: 10,borderColor: 'white',
            borderWidth: 3,}} />
      </View>

      <View style={styles.content}>
        <Text style={styles.profileName}>The Science of Storytelling</Text>
        ...
        <View style={styles.detail}>
          ...
          "วิล สตอร์" นักเขียนและนักเล่าเรื่องมากประสบการณ์ สกัดแก่นความรู้จากหลักสูตรพัฒนาการเล่าเรื่อง 
          </Text>
        </View>
